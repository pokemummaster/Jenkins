...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public List<Product> findByLevel(String level) {
        return productDao.findByLevel(level);
    }
    ...
    @Override
    public List<Product> findByCsidIn(List<Integer> id) {
        return productDao.findByCsidIn(id);
    }
